...
{
    /// <summary>
    ///     Class PDFOptionsConverter. From Syncfusion Demo
    /// </summary>
    /// <seealso cref="IMultiValueConverter" />
    public class PdfOptionsConverter : IMultiValueConverter
    {
        /// <summary>
        ///     Gets or sets a value indicating whether this instance is cutomized.
        /// </summary>
        /// <value><see langword="true" /> if this instance is cutomized; otherwise, <see langword="false" />.</value>
        public bool IsCutomized { get; set; }

        /// <summary>
        ///     Gets or sets a value indicating whether this instance is header footer enabled.
        /// </summary>
        /// <value><see langword="true" /> if this instance is header footer enabled; otherwise, <see langword="false" />.</value>
        public bool IsHeaderFooterEnabled { get; set; }
